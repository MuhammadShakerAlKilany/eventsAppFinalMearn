...
import { addAdmin, addPlace, deletePlace, edit, editPlace, getAllPlace, getPlaceByID, getUserPlace, placePhoto, removAdmin } from "../controller/place.controller"
...
router.route("/with_admin/:_id").all(guardAdmin,joiValidatorParams(idSchema)).patch(edit).delete(deletePlace)
